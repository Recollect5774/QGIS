...
const char *QgsApplication::QGIS_ORGANIZATION_NAME = "FYGIS";
const char *QgsApplication::QGIS_ORGANIZATION_DOMAIN = "fygis.org";
const char *QgsApplication::QGIS_APPLICATION_NAME = "FYGIS3";
